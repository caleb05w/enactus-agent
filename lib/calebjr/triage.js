    ...
    properties: {
      results: {
        ...
        items: {
          ...
          required: ['index', 'directedAtOwner', 'actionType', 'confidence', 'summary', 'redundant'],
        },
      },
    },
    required: ['results'],
...
- redundant: true if this request duplicates an existing open task below, OR restates/continues an earlier message in this same batch (e.g. several messages describing one feature). Mark the FIRST occurrence redundant=false and the rest redundant=true.
${existing}
Messages:
${list}`
