...
3. PR + REVIEW LOOP (/pr skill — guardrail-aware)
   ...
   - Then read every review comment (from the Claude/Codex review bots, if present), address each, accept reasonable suggestions, resolve the threads, and push.
   - Loop until both checks are green and there are no unresolved comments. Cap at 3 rounds; if still blocked, summarize what's outstanding in the PR and stop.
