...
export const REPOS = {
  ...
  'SKYES-Website': {
    name: 'SKYES-Website',
    url: 'https://github.com/caleb05w/SKYES-Website',
    ref: 'main',
    description: 'The SKYES program website. Requests specifically about the SKYES site, its pages or content.',
  },
  'enactus-agent': {
    name: 'enactus-agent',
    url: 'https://github.com/caleb05w/enactus-agent',
    ref: 'main',
    description: 'The Enactus web bot itself (this app): the finance/reimbursement portal pages, settings UI, and the Slack agents. Requests about "the enactus-web bot", the portal, or the bot\'s own pages route here.',
  },
}
