...
export async function postFinanceToSlack({ type, item, date, amount, etransferName, etransferEmail, receiptUrl, channel = 'agent_test' }) {
  ...
  await postMessage(CHANNELS[channel] ?? CHANNELS.agent_test, blocks)
}
